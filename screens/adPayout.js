import {
  ...
  export default function AdPayout({ navigation }) {
      ...
      <SafeAreaView style={styles.container} onLayout={onLayoutRootView}>
        ...
        <View style={styles.header}>
          ...
          <Ionicons
            ...
            style={styles.icon}
          />
          <Text style={[styles.title, { fontFamily: "Sans" }]}>Payment Screen</Text>
        </View>
        ...
        <View style={styles.content}>
          ...
          <ScrollView scrollEnabled>
            <View style={styles.section1}>
              ...
              <TextInput keyboardType="numeric" placeholder="duration" mode="outlined" outlineColor="#D2D2D2" contentStyle={{width: 186, backgroundColor:'#F6F6F6',borderRadius:5,fontFamily:'Sans'}}/>
            </View>
            ...
            <Text
              ...
              <TextInput keyboardType="numeric" left={<TextInput.Affix text="ZMW |"  textStyle={{color:'black', fontFamily:'Sans'}}/>} placeholder="20" mode="outlined" outlineColor="#D2D2D2" contentStyle={{backgroundColor:'#F6F6F6',borderRadius:5,fontFamily:'Sans', color:'black'}}/>
              <Text
                style={{
                  fontFamily: "Sans",
                  letterSpacing: 1,
            ...
            <Text style={{color:'black',fontFamily:'Sans',fontSize:24,lineHeight:31.25,paddingVertical:20}}>
              <Text style={{color:'#808080',lineHeight:24,fontSize:14}}>TOTAL:</Text> $200</Text>
              <Button
              mode="outlined"
              style={{
                paddingVertical: 10,
